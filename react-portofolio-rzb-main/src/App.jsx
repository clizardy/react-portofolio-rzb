...
import LandSaleWidget from './components/LandSaleModal';   
...
const PortfolioContent = () => {
    ...
    const [isPersonalDataVaultOpen, setIsPersonalDataVaultOpen] = useState(false);
        ...
        <>
            ...
            >
                ...
                <SidebarMenu 
                    ...
                    onOpenPersonalDataVault={() => setIsPersonalDataVaultOpen(true)}
                />
    ...
    <div className="relative z-10"> 
        <div id="hero" className="container mx-auto px-4 md:px-8">
                        ...
                        <Hero 
                            ...
                            isReady={!showWelcome} 
                        />
                        {/* FLOATING STICKY WIDGET (Melayang Ringan di Kiri Bawah) */}
      <div className="fixed bottom-6 left-6 z-[9999]">
    <LandSaleWidget
        lang={lang}
        theme={theme}
        onOpenDetails={() => setIsLandModalOpen(true)}
    />
</div>

      {/* MODAL DETAL TANAH (Satu Vibe dengan PersonalDataVault) */}
      <PersonalDataVault 
        isOpen={isLandModalOpen} 
        onClose={() => setIsLandModalOpen(false)} 
        // Anda bisa membuat duplikat PersonalDataVault khusus berisi spek tanah Anda di sini
      />
                        <SecretManager />
                    </div>
                ...
                <div className="relative z-[100]">
                    ...
                    <Suspense fallback={null}><PersonalDataVault lang={lang} isOpen={isPersonalDataVaultOpen} onClose={() => setIsPersonalDataVaultOpen(false)} /></Suspense>
    ...
    return (
        <MusicProvider> 
            ...
            <Routes>
                ...
                <Route path="/PersonalDataVault" element={<PersonalDataVault />} />
