...
// Icon Custom (History/Journey) - Tetap di ATAS agar tidak error
const FaHistoryIcon = () => (
...
const SidebarMenu = ({ lang }) => {
  ...
  return (
    <>
      {/* TOMBOL TRIGGER (STRIP TIGA) */}
      <motion.button
        initial={{ opacity: 0, scale: 0 }}
        animate={{ opacity: 1, scale: 1 }}
        whileHover={{ scale: 1.1 }} // Hapus rotate agar strip tetap rapi
        whileTap={{ scale: 0.9 }}
      ...
      >
        {/* 2. GUNAKAN ICON MENU ALT 3 (STRIP TIGA) */}
        <HiMenuAlt3 size={28} />
      </motion.button>
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 h-full w-80 bg-white/90 dark:bg-neutral-900/95 backdrop-blur-xl border-l border-neutral-200 dark:border-neutral-800 shadow-2xl z-[999] flex flex-col p-6 overflow-y-auto"
            >
